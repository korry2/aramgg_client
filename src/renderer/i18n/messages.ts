...
export const messages = {
  'zh-CN': {
    ...
    matchHistory: {
      title: '本地战绩采集',
      description: '通过 SGP 批量收集海克斯大乱斗摘要并按区服隔离保存。后台仅在大厅或空闲时自动刷新当前玩家，并逐步扩展直接同局玩家样本，无需操作。',
      games: '{count} 局',
      players: '{count} 名玩家',
  ...
  'en-US': {
    ...
    matchHistory: {
      title: 'LOCAL MATCH COLLECTION', description: 'Hextech ARAM summaries are stored separately by platform. While in Lobby or idle, background sync automatically refreshes the current player and gradually expands direct co-player coverage.', games: '{count} matches', players: '{count} players', hextechAramGames: 'ARAM: Mayhem {count}', pendingPlayers: '{count} matched players ready', platform: 'Platform {platform}', pendingUploads: '{count} matches queued to upload', currentPlayer: 'Current player: {name}', noCurrentPlayer: 'Waiting for automatic current-player collection', recentMatches: 'CURRENT PLAYER RECENT MATCHES', noRecentMatches: 'No local match history to display', hextechAramAugments: 'ARAM: MAYHEM · CHAMPION AUGMENTS', hextechAramAugmentsHint: 'Only KIWI / ARAM: Mayhem matches are included, grouped by champion + one augment.', hextechAramItems: 'ARAM: MAYHEM · CHAMPION FINAL ITEMS', hextechAramItemsHint: 'Only KIWI matches are included, grouped by champion + final inventory item; this is not purchase order.', noHextechAramAugmentStats: 'No ARAM: Mayhem augment samples collected yet', noHextechAramItemStats: 'No ARAM: Mayhem item samples collected yet', championFallback: 'Champion #{id}', augmentFallback: 'Augment #{id}', itemFallback: 'Item #{id}', winRate: 'Win {value}', samples: '{count} samples', victory: 'WIN', defeat: 'LOSS', placement: 'Place {placement}', updatedAt: 'Local update {time}', localLoadFailed: 'Failed to read local history: {error}',
    },
    itemSets: {
